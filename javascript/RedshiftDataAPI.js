...
exports.handler = async (event) => {
  ...
  for (const [command, query] of sqlStatements.entries()) {
    ...
    const res = await executeSqlDataApi(redshiftDataApiClient, redshiftClusterId, redshiftDatabaseName, redshiftUser, command, query, isSynchronous);
...
const executeSqlDataApi = async (redshiftDataApiClient, redshiftClusterId, redshiftDatabaseName, redshiftUser, command, query, isSynchronous) => {
  let queryId = '';
