...
<html>
<head>
<title>setup_sales_data_pipeline.sql - Amazon-redshift-data-api-getting-started - Code Browser</title>
<meta content='width=device-width, initial-scale=1' name='viewport'>
<meta content='true' name='use-sentry'>
<meta content='fafcb273-5ed6-48e4-bae9-3607da71c94e' name='request-id'>
<meta name="csrf-param" content="authenticity_token" />
<meta name="csrf-token" content="oW7hD17rnJDIk2hiQkQU+tSBg8eABFSLFBdZmInMrQOdhr/+H9wRL16sA/KzvuDcpaMNRBg8NQfo3ftKau2big==" />
...
<li class='.active'>setup_sales_data_pipeline.sql</li>
...
<input type="hidden" name="path" id="path" value="use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql" />
</form>
...
<form action="/create_relation" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="FnknVdXjlt1/NlLNGi4rtNM5+FTqW63B8ZJjrbNPkRQqkXmklNQbYukJOV3r1N+Soht213JjzE0NWMF/UG6nnQ==" />
...
<div class='path_breadcrumbs'>
<span class='path_breadcrumb'><a href="/packages/Amazon-redshift-data-api-getting-started">Amazon-redshift-data-api-getting-started</a></span>/<span class='path_breadcrumb'><a href="/packages/Amazon-redshift-data-api-getting-started/trees/mainline/--/">mainline</a></span>/<span class='path_breadcrumb'><a href="/packages/Amazon-redshift-data-api-getting-started/trees/mainline/--/use-cases">use-cases</a></span>/<span class='path_breadcrumb'><a href="/packages/Amazon-redshift-data-api-getting-started/trees/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions">etl-orchestration-with-lambda-and-step-functions</a></span>/<span class='path_breadcrumb'><a href="/packages/Amazon-redshift-data-api-getting-started/trees/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts">scripts</a></span>/<span class='path_breadcrumb'>setup_sales_data_pipeline.sql</span>
</div>
...
<li>
<a class="minibutton" href="/packages/Amazon-redshift-data-api-getting-started/blobs/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql?raw=1">Raw</a>
</li>
<li>
<a class="minibutton" href="/packages/Amazon-redshift-data-api-getting-started/blobs/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql?download=1">Download</a>
</li>
<li>
<a class="minibutton" href="/packages/Amazon-redshift-data-api-getting-started/logs/mainline?path=use-cases%2Fetl-orchestration-with-lambda-and-step-functions%2Fscripts%2Fsetup_sales_data_pipeline.sql">History</a>
</li>
<li>
<a class="minibutton" href="/packages/Amazon-redshift-data-api-getting-started/blobs/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql/edit_file_online">Edit</a>
</li>
<li class='permalink'>
<a class="minibutton" href="/packages/Amazon-redshift-data-api-getting-started/blobs/a6e7ec90e95ea7a4ab121ed9a984a468b53e08a4/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql">Permalink</a>
</li>
</ul>
      ...
      <table class="code js-syntax-highlight">
        <tbody>
            ...
            <tr class="line_holder" id="L1">
              ...
              <td class="line_content"><span class="k">drop</span> <span class="k">table</span> <span class="n">if</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">customer</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L2">
              ...
              <td class="line_content"><span class="k">drop</span> <span class="k">table</span> <span class="n">if</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">customer_address</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L3">
              ...
              <td class="line_content"><span class="k">drop</span> <span class="k">table</span> <span class="n">if</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">date_dim</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L4">
              ...
              <td class="line_content"><span class="k">drop</span> <span class="k">table</span> <span class="n">if</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">item</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L5">
              ...
              <td class="line_content"><span class="k">drop</span> <span class="k">table</span> <span class="n">if</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">store_sales</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L7">
              ...
              <td class="line_content"><span class="k">create</span> <span class="k">table</span> <span class="n">if</span> <span class="k">not</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">customer</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L8">
              ...
              <td class="line_content"><span class="p">(</span><span class="n">c_customer_sk</span>          <span class="n">int4</span>     <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L9">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">c_customer_id</span>          <span class="nb">char</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L10">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">c_current_addr_sk</span>      <span class="n">int4</span>              <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L11">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">c_first_name</span>           <span class="nb">char</span><span class="p">(</span><span class="mi">20</span><span class="p">)</span>          <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L12">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">c_last_name</span>            <span class="nb">char</span><span class="p">(</span><span class="mi">30</span><span class="p">)</span>          <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L13">
              ...
              <td class="line_content"><span class="p">,</span><span class="k">primary</span> <span class="k">key</span> <span class="p">(</span><span class="n">c_customer_sk</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L15">
              ...
              <td class="line_content"><span class="n">distkey</span><span class="p">(</span><span class="n">c_customer_sk</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L16">
              ...
              <td class="line_content"><span class="c1">--</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L17">
              ...
              <td class="line_content"><span class="k">create</span> <span class="k">table</span> <span class="n">if</span> <span class="k">not</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">customer_address</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L18">
              ...
              <td class="line_content"><span class="p">(</span><span class="n">ca_address_sk</span>    <span class="n">int4</span>     <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L19">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ca_address_id</span>    <span class="nb">char</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L20">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ca_state</span>         <span class="nb">char</span><span class="p">(</span><span class="mi">2</span><span class="p">)</span>           <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L21">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ca_zip</span>           <span class="nb">char</span><span class="p">(</span><span class="mi">10</span><span class="p">)</span>          <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L23">
              ...
              <td class="line_content"><span class="p">,</span><span class="k">primary</span> <span class="k">key</span> <span class="p">(</span><span class="n">ca_address_sk</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L25">
              ...
              <td class="line_content"><span class="n">distkey</span><span class="p">(</span><span class="n">ca_address_sk</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L27">
              ...
              <td class="line_content"><span class="k">create</span> <span class="k">table</span> <span class="n">if</span> <span class="k">not</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">date_dim</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L28">
              ...
              <td class="line_content"><span class="p">(</span><span class="n">d_date_sk</span>           <span class="nb">integer</span>  <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L29">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">d_date_id</span>           <span class="nb">char</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L30">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">d_date</span>              <span class="nb">date</span>              <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L31">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">d_day_name</span>          <span class="nb">char</span><span class="p">(</span><span class="mi">9</span><span class="p">)</span>           <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L32">
              ...
              <td class="line_content"><span class="p">,</span><span class="k">primary</span> <span class="k">key</span> <span class="p">(</span><span class="n">d_date_sk</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L34">
              ...
              <td class="line_content"><span class="n">diststyle</span> <span class="k">all</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L36">
              ...
              <td class="line_content"><span class="k">create</span> <span class="k">table</span> <span class="n">if</span> <span class="k">not</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">item</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L37">
              ...
              <td class="line_content"><span class="p">(</span><span class="n">i_item_sk</span>        <span class="n">int4</span>     <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L38">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_item_id</span>        <span class="nb">char</span><span class="p">(</span><span class="mi">16</span><span class="p">)</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L39">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_rec_start_date</span> <span class="nb">date</span>              <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L40">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_rec_end_date</span>   <span class="nb">date</span>              <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L41">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_current_price</span>  <span class="nb">numeric</span><span class="p">(</span><span class="mi">7</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>      <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L42">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_category</span>       <span class="nb">char</span><span class="p">(</span><span class="mi">50</span><span class="p">)</span>          <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L43">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">i_product_name</span>   <span class="nb">char</span><span class="p">(</span><span class="mi">50</span><span class="p">)</span>          <span class="n">encode</span> <span class="n">zstd</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L44">
              ...
              <td class="line_content"><span class="p">,</span><span class="k">primary</span> <span class="k">key</span> <span class="p">(</span><span class="n">i_item_sk</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L46">
              ...
              <td class="line_content"><span class="n">distkey</span><span class="p">(</span><span class="n">i_item_sk</span><span class="p">)</span> <span class="n">sortkey</span><span class="p">(</span><span class="n">i_category</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L48">
              ...
              <td class="line_content"><span class="k">create</span> <span class="k">table</span> <span class="n">if</span> <span class="k">not</span> <span class="k">exists</span> <span class="k">public</span><span class="p">.</span><span class="n">store_sales</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L49">
              ...
              <td class="line_content"><span class="p">(</span><span class="n">ss_sold_date_sk</span>       <span class="n">int4</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L50">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_item_sk</span>            <span class="n">int4</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L51">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_customer_sk</span>        <span class="n">int4</span>          <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L52">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_addr_sk</span>            <span class="n">int4</span>          <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L53">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_store_sk</span>           <span class="n">int4</span>          <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L54">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_ticket_number</span>      <span class="n">int8</span> <span class="k">not</span> <span class="k">null</span> <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L55">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_quantity</span>           <span class="n">int4</span>          <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L56">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_net_paid</span>           <span class="nb">numeric</span><span class="p">(</span><span class="mi">7</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>  <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L57">
              ...
              <td class="line_content"><span class="p">,</span><span class="n">ss_net_profit</span>         <span class="nb">numeric</span><span class="p">(</span><span class="mi">7</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>  <span class="n">encode</span> <span class="n">az64</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L58">
              ...
              <td class="line_content"><span class="p">,</span><span class="k">primary</span> <span class="k">key</span> <span class="p">(</span><span class="n">ss_item_sk</span><span class="p">,</span> <span class="n">ss_ticket_number</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L60">
              ...
              <td class="line_content"><span class="n">distkey</span><span class="p">(</span><span class="n">ss_item_sk</span><span class="p">)</span> <span class="n">sortkey</span><span class="p">(</span><span class="n">ss_sold_date_sk</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L64">
              ...
              <td class="line_content"><span class="k">truncate</span> <span class="k">table</span> <span class="k">public</span><span class="p">.</span><span class="n">customer</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L65">
              ...
              <td class="line_content"><span class="k">insert</span> <span class="k">into</span> <span class="k">public</span><span class="p">.</span><span class="n">customer</span> <span class="p">(</span><span class="n">c_customer_sk</span><span class="p">,</span><span class="n">c_customer_id</span><span class="p">,</span><span class="n">c_current_addr_sk</span><span class="p">,</span><span class="n">c_first_name</span><span class="p">,</span><span class="n">c_last_name</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L67">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">7550</span><span class="p">,</span><span class="s1">'AAAAAAAAOHNBAAAA'</span><span class="p">,</span><span class="mi">9264662</span><span class="p">,</span><span class="s1">'Michelle'</span><span class="p">,</span><span class="s1">'Deaton'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L68">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">37079</span><span class="p">,</span><span class="s1">'AAAAAAAAHNAJAAAA'</span><span class="p">,</span><span class="mi">13971208</span><span class="p">,</span><span class="s1">'Michael'</span><span class="p">,</span><span class="s1">'Simms'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L69">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">40626</span><span class="p">,</span><span class="s1">'AAAAAAAACLOJAAAA'</span><span class="p">,</span><span class="mi">1959255</span><span class="p">,</span><span class="s1">'Susan'</span><span class="p">,</span><span class="s1">'Ryder'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L70">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2142876</span><span class="p">,</span><span class="s1">'AAAAAAAAMJCLACAA'</span><span class="p">,</span><span class="mi">7644556</span><span class="p">,</span><span class="s1">'Justin'</span><span class="p">,</span><span class="s1">'Brown'</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L71">
              ...
              <td class="line_content"><span class="k">analyze</span> <span class="k">public</span><span class="p">.</span><span class="n">customer</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L73">
              ...
              <td class="line_content"><span class="k">truncate</span> <span class="k">table</span> <span class="k">public</span><span class="p">.</span><span class="n">customer_address</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L76">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">13971208</span><span class="p">,</span><span class="s1">'AAAAAAAAIAPCFNAA'</span><span class="p">,</span><span class="s1">'NE'</span><span class="p">,</span><span class="s1">'63451'</span><span class="p">,</span><span class="s1">'United States'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L77">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">7644556</span><span class="p">,</span><span class="s1">'AAAAAAAAMIFKEHAA'</span><span class="p">,</span><span class="s1">'SD'</span><span class="p">,</span><span class="s1">'58883'</span><span class="p">,</span><span class="s1">'United States'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L78">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">9264662</span><span class="p">,</span><span class="s1">'AAAAAAAAGBOFNIAA'</span><span class="p">,</span><span class="s1">'CA'</span><span class="p">,</span><span class="s1">'99310'</span><span class="p">,</span><span class="s1">'United States'</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L79">
              ...
              <td class="line_content"><span class="k">analyze</span> <span class="k">public</span><span class="p">.</span><span class="n">customer_address</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L81">
              ...
              <td class="line_content"><span class="k">truncate</span> <span class="k">table</span> <span class="k">public</span><span class="p">.</span><span class="n">item</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L82">
              ...
              <td class="line_content"><span class="k">insert</span> <span class="k">into</span> <span class="k">public</span><span class="p">.</span><span class="n">item</span> <span class="p">(</span><span class="n">i_item_sk</span><span class="p">,</span><span class="n">i_item_id</span><span class="p">,</span><span class="n">i_rec_start_date</span><span class="p">,</span><span class="n">i_rec_end_date</span><span class="p">,</span><span class="n">i_current_price</span><span class="p">,</span><span class="n">i_category</span><span class="p">,</span><span class="n">i_product_name</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L84">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">3417</span><span class="p">,</span><span class="s1">'AAAAAAAAIFNAAAAA'</span><span class="p">,</span><span class="s1">'2021-04-27'</span><span class="p">,</span><span class="k">NULL</span><span class="p">,</span><span class="mi">14</span><span class="p">.</span><span class="mi">29</span><span class="p">,</span><span class="s1">'Electronics'</span><span class="p">,</span><span class="s1">'ationoughtesepri'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L85">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">9615</span><span class="p">,</span><span class="s1">'AAAAAAAAOIFCAAAA'</span><span class="p">,</span><span class="s1">'2021-04-27'</span><span class="p">,</span><span class="k">NULL</span><span class="p">,</span><span class="mi">9</span><span class="p">.</span><span class="mi">68</span><span class="p">,</span><span class="s1">'Home'</span><span class="p">,</span><span class="s1">'antioughtcallyn st'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L86">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">3693</span><span class="p">,</span><span class="s1">'AAAAAAAAMGOAAAAA'</span><span class="p">,</span><span class="s1">'2021-06-26'</span><span class="p">,</span><span class="k">NULL</span><span class="p">,</span><span class="mi">2</span><span class="p">.</span><span class="mi">10</span><span class="p">,</span><span class="s1">'Men'</span><span class="p">,</span><span class="s1">'prin stcallypri'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L87">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">3630</span><span class="p">,</span><span class="s1">'AAAAAAAAMCOAAAAA'</span><span class="p">,</span><span class="s1">'2021-03-14'</span><span class="p">,</span><span class="k">NULL</span><span class="p">,</span><span class="mi">2</span><span class="p">.</span><span class="mi">95</span><span class="p">,</span><span class="s1">'Electronics'</span><span class="p">,</span><span class="s1">'barpricallypri'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L88">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">16506</span><span class="p">,</span><span class="s1">'AAAAAAAAIHAEAAAA'</span><span class="p">,</span><span class="s1">'2021-03-14'</span><span class="p">,</span><span class="k">NULL</span><span class="p">,</span><span class="mi">3</span><span class="p">.</span><span class="mi">85</span><span class="p">,</span><span class="s1">'Home'</span><span class="p">,</span><span class="s1">'callybaranticallyought'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L91">
              ...
              <td class="line_content"><span class="k">analyze</span> <span class="k">public</span><span class="p">.</span><span class="n">item</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L92">
              ...
              <td class="line_content"><span class="k">truncate</span> <span class="k">table</span> <span class="k">public</span><span class="p">.</span><span class="n">date_dim</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L93">
              ...
              <td class="line_content"><span class="k">insert</span> <span class="k">into</span> <span class="k">public</span><span class="p">.</span><span class="n">date_dim</span> <span class="p">(</span><span class="n">d_date_sk</span><span class="p">,</span><span class="n">d_date_id</span><span class="p">,</span><span class="n">d_date</span><span class="p">,</span><span class="n">d_day_name</span><span class="p">)</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L95">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2450521</span><span class="p">,</span><span class="s1">'AAAAAAAAJFEGFCAA'</span><span class="p">,</span><span class="s1">'2020-03-12'</span><span class="p">,</span><span class="s1">'Thursday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L96">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2450749</span><span class="p">,</span><span class="s1">'AAAAAAAANDFGFCAA'</span><span class="p">,</span><span class="s1">'2020-04-27'</span><span class="p">,</span><span class="s1">'Monday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L97">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2451251</span><span class="p">,</span><span class="s1">'AAAAAAAADDHGFCAA'</span><span class="p">,</span><span class="s1">'2020-03-13'</span><span class="p">,</span><span class="s1">'Saturday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L98">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2451252</span><span class="p">,</span><span class="s1">'AAAAAAAAEDHGFCAA'</span><span class="p">,</span><span class="s1">'2021-03-14'</span><span class="p">,</span><span class="s1">'Sunday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L99">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2451981</span><span class="p">,</span><span class="s1">'AAAAAAAANAKGFCAA'</span><span class="p">,</span><span class="s1">'2021-03-12'</span><span class="p">,</span><span class="s1">'Monday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L100">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2451982</span><span class="p">,</span><span class="s1">'AAAAAAAAOAKGFCAA'</span><span class="p">,</span><span class="s1">'2021-03-13'</span><span class="p">,</span><span class="s1">'Tuesday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L101">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2452210</span><span class="p">,</span><span class="s1">'AAAAAAAACPKGFCAA'</span><span class="p">,</span><span class="s1">'2021-04-27'</span><span class="p">,</span><span class="s1">'Saturday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L102">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2452641</span><span class="p">,</span><span class="s1">'AAAAAAAABKMGFCAA'</span><span class="p">,</span><span class="s1">'2021-06-25'</span><span class="p">,</span><span class="s1">'Wednesday'</span><span class="p">),</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L103">
              ...
              <td class="line_content"><span class="p">(</span><span class="mi">2452642</span><span class="p">,</span><span class="s1">'AAAAAAAACKMGFCAA'</span><span class="p">,</span><span class="s1">'2021-06-26'</span><span class="p">,</span><span class="s1">'Thursday'</span><span class="p">);</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L105">
              ...
              <td class="line_content"><span class="k">analyze</span> <span class="k">public</span><span class="p">.</span><span class="n">date_dim</span><span class="p">;</span>
</td>
            </tr>
            ...
            <tr class="line_holder" id="L106">
              ...
              <td class="line_content"><span class="c1">--  commit and End transaction</span>
</td>
            </tr>
...
<script>
  $(document).ready(function() {
      $('#branches').select2({
          width: "274px",
          data: [{"text":"This Commit's Parents","children":[{"text":"a6e7ec90^1 (80d94d6d)","id":"/packages/Amazon-redshift-data-api-getting-started/blobs/80d94d6de753891e698d5c908262a93d38268dbc/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql"}]},{"text":"Official Branches","children":[{"text":"dev-general-readme","id":"/packages/Amazon-redshift-data-api-getting-started/blobs/heads/dev-general-readme/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql"},{"text":"dev-java","id":"/packages/Amazon-redshift-data-api-getting-started/blobs/heads/dev-java/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql"},{"text":"mainline (default)","id":"/packages/Amazon-redshift-data-api-getting-started/blobs/heads/mainline/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql"}]}],
          createSearchChoice: function(term, data) {
            if ($(data).filter(function() { return this.text.localeCompare(term)===0; }).length===0) {
              ...
              if ('/packages/Amazon-redshift-data-api-getting-started/blobs/'.match(/\/logs/)) {
                ...
                if ('use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql') {
                  id_string += '/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql';
                }
                return {text:term, id: id_string};
              }
              return {text:term, id:'/packages/Amazon-redshift-data-api-getting-started/blobs/' + term + '/--/use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql'};
            }
          },
      });
  ...
  (function() {
    $(function() {
      ...
      b = new Codac.Blame({
        ...
        path: 'use-cases/etl-orchestration-with-lambda-and-step-functions/scripts/setup_sales_data_pipeline.sql',
        show: 'false'
      });
      return b.doBlame();
    });
