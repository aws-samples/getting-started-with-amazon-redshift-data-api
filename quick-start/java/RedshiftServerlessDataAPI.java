...
public class RedshiftDataAPI implements RequestHandler<Map<String, String>, String> {
    ...
    public String handleRequest(Map<String, String> event, Context context) {
		...
		String redshiftWorkgroupName=event.get("redshift_workgroup_name");
        ...
        sqlStatements.forEach((command, query) -> {
            try {
                ...
                responses.put(command + " STATUS: ", executeSqlDataApi(redshiftDataApiClient, redshiftWorkgroupName,
                        redshiftDatabaseName, command, query, isSynchronous, logger));
    ...
    private String executeSqlDataApi(AWSRedshiftDataAPI redshiftDataApiClient, String redshiftWorkgroupName,
            String redshiftDatabaseName, String command, String query, boolean isSynchronous,
